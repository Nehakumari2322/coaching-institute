              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="form-outline">
                    <input
                      ...
                      name="family_name"
                      class="form-control"
                      value="<?php echo $data->applicant_name;?>"
                    />
                  </div>
                </div>
                ...
                <div class="form-outline">
                  <input
                    ...
                    name="family_no"
                    class="form-control"
                    value="<?php echo $data->family_member_count; ?>" required min="1" max="125"
                  />
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="form-outline">
                  <input
                    ...
                    name="aadhar_no"
                    class="form-control"
                    value="<?php echo $data->aadhar_no; ?>" required  max="999999999999"
                  />
                </div>
                ...
                <div class="form-outline">
                  <input
                    ...
                    name="contact_no"
                    class="form-control"
                    value="<?php echo $data->mobile_no; ?>" required min="1000000000" max="9999999999"
                  />
                </div>
              </div>
              <!-- State & Districts -->
              ...
              <div class="row">
                ...
                <div class="form-outline">
                  <input
                    ...
                    name="village"
                    class="form-control"
                    value="<?php echo $data->village_name; ?>" required
                  />
                </div>
                ...
                <div class="form-outline">
                  <input
                    ...
                    name="pin_code"
                    class="form-control"
                    value="<?php echo $data->pincode; ?>" required min="100000" max="999999"
                  />
                </div>
              </div>
              <div class="row">
                ...
                <div class="form-outline">
                  <input
                    ...
                    name="address"
                    class="form-control"
                    value="<?php echo $data->full_address; ?>"
                  />
                </div>
              </div>
              <div class="row mt-2">
                <div class="col-sm-6 col-md-6 col-6">
                  ...
                  <input type="radio" name="gasconn" value="Yes" <?php if($data->gas_conn_available == '1'){ echo "checked";}?>>Yes
                  <input type="radio" name="gasconn" value="No" <?php if($data->gas_conn_available == '0'){ echo "checked";}?>>No
                </div>
                <!-- Bpl Registerd-->
                <div class="col-sm-6 col-md-6 col-6">
                  <span class='fw-bold'>BPL Registerd</span>
                  <input type="radio" name="bplreg" value="Yes" <?php if ($data->bpl_registered == '1') echo "checked";?>>Yes
                  <input type="radio" name="bplreg" value="No" <?php if ($data->bpl_registered == '0') echo "checked";?>>No
                </div>
              </div>
              <!-- Submit button -->
