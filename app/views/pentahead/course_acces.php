...
<div class="container">
    <div class="row mt-3">
        <div class="d-flex justify-content-end">
            <a class="btn mb-4" href="<?php echo $result->life_link;?>" target="_blank" style="width:20%;background:red;color:white" data-bs-placement="right">Go live  <img src="<?php echo URLROOT."/img/live.png";?>"  height="30px" alt=""></a>
        </div>
        ...
        <?php $count = 0; foreach($moreData as $dataline){ ?>
            <div class="col-sm-2">
                <div class="card" style="border:none">
                    ...
                    <a type="submit" class="btn btn-sm mt-3"  target="_blank" href="<?php echo URLROOT.'/notes/'.$dataline->pdf_path;?>"  style="background:#40caf9;width:60%;color:white;display:block;margin:auto">View Notes <img src="<?php echo URLROOT."/img/pdf.png";?>" height="20px" alt=""></a>
