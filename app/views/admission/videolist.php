...
<form action="<?php echo URLROOT ;?>admissions/video_details" method="post" >
<div class="container">
            ...
            <div class="card">
                    <table class="table table-striped text-center  table-hover" >
                        ...
                        <tbody>
                            ...
                            <input type="hidden" name="<?php echo 'video_no'.$count;?>" id="<?php echo 'video_no'.$count;?>"  value="<?php echo $dataline->video_no;?>">
                            <td><?php echo $dataline->video_path;?></td>
