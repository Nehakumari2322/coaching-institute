...
<form action="<?php echo URLROOT ;?>admissions/editswiper" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td ><img src="<?php echo URLROOT.'/img/'.$dataline->image;?>" height="50px" width="100px" alt=""></td>
                <td >
